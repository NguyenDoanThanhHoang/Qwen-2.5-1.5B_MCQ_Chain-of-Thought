...
def create_template_rejected(wrong_answer: str, wrong_choice: str, use_advanced: bool, explanation: str) -> str:
    """Create template-based rejected sample when SFT sample unavailable"""
    if use_advanced:
...
def create_dpo_pair(example: Dict, rejected_map: dict = None, use_advanced_rejected: bool = False) -> Dict:
    ...
    all_answers = [chr(65 + i) for i in range(num_choices)]
